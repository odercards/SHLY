$(window).scroll(function() {
  // 100 = The point you would like to fade the nav in.
    ...
    // 標題
      $('.s00, .s01, .s02, .s03, .s04, .s05, .s06, .s07, .s08, .s09, .s10, .s11, .sAA, .sBB').stop().animate({
        opacity: 1
      }, 200 );
      $('.m01, .m02, .m03, .m04, .m05, .m06, .m07, .m08, .m09, .m10, .m11').stop().animate({
        opacity : 0
      }, 200 );
    ...
    // 第十頁
      ...
      $('.m08, .s08, .m09, .s09, .m11, .s11, .mAA, .sAA').stop().animate({
        opacity: 0
      }, 200 );
    ...
    // 第十一頁
      ...
      $('.m09, .s09, .m10, .s10, .mAA, .sAA, .mBB, .sBB').stop().animate({
        opacity: 0
      }, 200 );
    ...
    // 第補充頁
      ...
      $('.m10, .s10, .m11, .s11, .mBB, .sBB').stop().animate({
        opacity: 0
      }, 200 );
